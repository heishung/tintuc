        ...
        <div class="row">
            ...
            <div class="col-md-9 ">
                <div class="panel panel-default">
                    ...
                    <?php foreach ($danhmuctin as $tt){ $tt->TieuDe ?>
                    ...
                    <div class="row-item row">
                        <div class="col-md-3">
                            ...
                            <a href="detail.html">
                                <br>
                                <img width="200px" height="200px" class="img-responsive" src="public/image/tintuc/<?= $tt->Hinh ?>" alt="">
                            </a>
                        </div>
